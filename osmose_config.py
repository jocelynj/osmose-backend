...
us_state = gen_country('north-america/us', country_base='usa', language='en', speed_limit_unit='mph', boundary_require_admin_centre=False, allow_boundary_admin_level_intersection=[6, 8])
